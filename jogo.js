...
function criaCanos() {
  const canos = {
    ...
    temColisaoComOFlappyBird(par) {
      ...
      const flappyBirdWidth =
        globais.flappyBird.x + globais.flappyBird.width - 5;

      if (flappyBirdWidth >= par.x) {
...
const mensagemGameOver = {
  ...
  atualiza() {
    console.log("Placar: ", criaPlacar().pontuacao);
    // const placar = criaPlacar().pontuacao;
    // console.log(placar);
    // contexto.font = "35px 'VT323'";
    // contexto.textAlign = "right";
    // contexto.fillStyle = "white";
    // contexto.fillText(`${placar}`, canvas.width - 10, 35);
  },
};
